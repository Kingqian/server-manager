...
import com.ruoyi.system.api.JSHApi;
...
public class LinkServerServiceImpl implements ILinkServerService {
     ...
     */
    @Override
    public int connect(ConnectRequest  request) {
        Session session = jshApi.connect(request);
        jshApi.close(session);
        return 1;
    }
}
